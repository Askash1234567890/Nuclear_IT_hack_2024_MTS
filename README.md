...
4. __Формирование облака слов__. В каждом сформированным кластере было посчитано количество входящих слов, а также 1 слово выбрано наугад с равномерной плотностью распределения вероятности. Результат занесен в словарь, который податся на вход формирователю облака слов. Для непосредственно формирования облака слов был использован встроенный модуль *wordcloud*.
